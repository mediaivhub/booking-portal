...
type Page = "home" | "history" | "inventory" | "team";
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--bg)" }}>
      ...
      <main className="flex-1 overflow-y-auto" style={{ paddingBottom: "80px", WebkitOverflowScrolling: "touch" }}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  title="Export"
                  className="h-8 w-8 sm:w-auto sm:px-3 rounded-lg flex items-center justify-center gap-1.5 border transition-colors hover:brightness-90"
                  style={{ borderColor: "var(--border)", color: "var(--text-2)" }}
                >
        ...
        {page === "inventory" && <InventoryTab isAdmin />}

...
export const VIAL_NAMES = ["EFM", "LCD", "IMB", "PST", "MG NAD", "VM", "MIC", "Vit B", "Vit C", "NAD"];
export const MEDICINE_NAMES = ["ALA", "Revita Vit D", "Coq 10", "Gluta", "Scopinal", "PCM", "Iron", "Voltaren", "Pantop", "Dexa", "Vomron", "B12", "Vit D IM"];
